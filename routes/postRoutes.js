...
router.route("/").post(authenticate, active, createPostValidator, createPost);
router.route("/:id").put(authenticate, active, editPostValidator, postsAuthorization, updatePost);
