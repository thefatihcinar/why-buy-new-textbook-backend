...
const createPostValidator = [
  ...
  body('title').isLength({ min: 6, max: 125}).withMessage(msg.TITLE_LENGTH_MINIMUM_MAXIMUM_CHARACTERS),
  ...
  body('description').isLength({ min: 10, max: 20000 }).withMessage(msg.DESCRIPTION_LENGTH_MINIMUM_MAXIMUM_CHARACTERS),
