...
export default {
  ...
  PASSWORD_MUST_CONTAIN_AT_LEAST_ONE_SPECIAL_CHARACTER: 'Şifreniz en az bir özel karakter içermelidir.',
  PASSWORD_MUST_CONTAIN_AT_LEAST_ONE_NUMBER: 'Şifreniz en az bir sayı içermelidir.',
  PASSWORD_IS_INCORRECT_FORM: 'Şifreniz hatalı formatta.',
  EMAIL_EMPTY: 'Email boş olamaz.',
